...
//   const AddAdvantages({Key? key, this.oneApartment, this.isChecked = false})
//       : super(key: key);
...
//               widget.oneApartment!.advantages!.map((feature) {
//         return Row(
...
//     var data = json["data"] as List<dynamic>;
//     for (var value in data) {
//       widget.oneApartment?.advantages?.add(Advantages(
//         id: value['id'],
//         advName: value['adv_name'],
//         icon: value['icon'],
//         // checkedId: value['checked_id']
//       ));
//       setState(() {
//         widget.oneApartment?.advantages?.first;
//         // advantages = chosen;
