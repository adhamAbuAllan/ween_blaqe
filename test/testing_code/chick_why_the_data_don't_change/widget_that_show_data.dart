...
//                 }
//                 // getDataTest.update();
//                 debugPrint("the items in getDataTest.items: --${getDataTest.items}");
//                 Navigator.push(
//                     context,
//                     MaterialPageRoute(
...
//               debugPrint(
//                   "the index of getDataTest.index + 1 : --${getDataTest.index + 1}");
//               debugPrint("the items of getDataTest.items: --${getDataTest.items}");
//               debugPrint("the items of getDataTest.index of type: --${getDataTest.indexOfType+1}");
//             },
...
//                     // getDataTest.index = i;
//                     debugPrint("the index of getDataTest.indexOfType+1:"
//                         " --${getDataTest.indexOfType + 1}");
//                   }
//                 }
//                 // getDataTest.update();
//                 debugPrint("the itemsOfType :$testList");
//                 Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => const AnotherWidget(),
