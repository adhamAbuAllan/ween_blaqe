...
class ShowMoreSkeletonWidget extends StatefulWidget {
  const ShowMoreSkeletonWidget({Key? key}) : super(key: key);

  @override
  State<ShowMoreSkeletonWidget> createState() => _ShowMoreSkeletonWidgetState();
}

class _ShowMoreSkeletonWidgetState extends State<ShowMoreSkeletonWidget> {
  @override
