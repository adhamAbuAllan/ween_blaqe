...
class SmallParagraphSkeletonReady extends StatefulWidget {
  ...
  @override
  State<SmallParagraphSkeletonReady> createState() => _SmallParagraphSkeletonReadyState();
}

class _SmallParagraphSkeletonReadyState extends State<SmallParagraphSkeletonReady> {
 @override
  void initState() {
    super.initState();
    // Timer(
          ...
          children: [
            SkeletonParagraph(
                style: SkeletonParagraphStyle(
                    lines: 1,
                    padding: EdgeInsets.fromLTRB(0, 50, 25, 20),
            ...
            SkeletonParagraph(
                style: SkeletonParagraphStyle(
                    lines: 3,
                    spacing: 10,
                    padding: EdgeInsetsDirectional.fromSTEB(30, 0, 50, 10),
                    lineStyle: SkeletonLineStyle(
                      height: 20,
                      borderRadius: BorderRadius.circular(7 / 2),
                    ))),
            SkeletonParagraph(
                style: SkeletonParagraphStyle(
                    lines:3,
                    spacing: 10,
                    padding: EdgeInsetsDirectional.fromSTEB(30, 10, 70, 10),
                    lineStyle: SkeletonLineStyle(
                      height: 20,
                      borderRadius: BorderRadius.circular(7 / 2),
                    ))),
            ...
            children: [
              ...
              SkeletonParagraph(
                  style: SkeletonParagraphStyle(
                      lines: 2,
                      spacing: 10,
                      padding: EdgeInsetsDirectional.fromSTEB(30, 10, 130, 10),
                      lineStyle: SkeletonLineStyle(
                        height: 20,
                        borderRadius: BorderRadius.circular(7 / 2),
                      ))),
