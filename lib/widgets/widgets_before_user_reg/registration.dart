...
import '/classes_that_effect_widgets/dropdown_classes_widgets/dropdown_type_of_user.dart';
import '/classes_that_effect_widgets/dropdown_classes_widgets/dropdown_unviversty.dart';
import '/classes_that_effect_widgets/registration/text_field_of_password_class_widget.dart';
                      ...
                      onPressed: () async {
                        ...
                        setState(() {
                          if(passwordController.text != surePasswordController.text){
                            NormalAlert.show(context, "كلمة المرور غير متطابقة", "برجاء إدخال كلمة مرور متطابقة في كلا الحقلين", "حسنًا");
                          }
                          go(nameController.text,
    ...
    if (res.status == false) {
      setState(() {
        ...
        if(msg=="The phone has already been taken."){
          NormalAlert.show(context, "بيانات خاطئة", "جرب إستخدام رقم هاتف مختلف", "حسنًا");
          return;
        }
        if(msg=="The name field is required."){
          NormalAlert.show(context, "حقل مطلوب", "يرجى تعبئة حقل 'الاسم الكامل'", "حسنًا");
          return;
        }
        if(msg=="The phone field is required."){
          NormalAlert.show(context, "حقل مطلوب", "يرجى تعبئة حقل 'رقم الهاتف'", "حسنًا");
          return;
        }
        if(msg=="The password field is required."){
          NormalAlert.show(context, "حقل مطلوب", "يرجى تعبئة حقل 'كلمة المرور'", "حسنًا");
          return;
        }
      });
      removeUserInfo();
