...
class SendNoticeForUs extends StatefulWidget {
   SendNoticeForUs({Key? key}) : super(key: key);
...
class _SendNoticeForUsState extends State<SendNoticeForUs> {
  ...
  var sendNoticeForUsHint="أقترح إضافة خاصية البحث عن شركاء حيث يستطيع الطالب البحث عن شريك له يشاركه في الشقة من خلال التطبيق";
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: (){
                  ...
                  if(sendNoticeForUcController.text == ""||sendNoticeForUcController.text.length <35){
  ...
  go(String comment)async{
    ...
    var uri = Uri.parse(ServerLocalhostEm.commentAdd);
