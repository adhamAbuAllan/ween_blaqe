            ...
            Padding(
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      AskForHelpButton(() {
                        myPushName(context, MyPagesRoutes.howCouldBookingApartment);
                      }, "كيف يمكنني حجز شقة؟"),
                      ...
                      aline,
                      AskForHelpButton(() {
                        myPushName(context, MyPagesRoutes.howLongIsTheReservationAvailable);
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child:  Text("يتطلب حجز شقة على تطبيق 'وين بلاقي' تسجيل دخول المستخدم أولاً ثم إتباع الخطوات التالية",
                  style: TextStyle(
                    fontSize: 16.0,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child: const Text("الخطوة الاولى",
                  style: TextStyle(
                    fontSize: 18.0,
                    fontFamily: 'IBM',
                    inherit: true,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child:  Text("بعد إختيارك لأعلان ما اظغط على زر احجز الان",
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.grey.shade800,
                    fontFamily: 'IBM',
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child: const Text("الخطوة الثانية",
                  style: TextStyle(
                    fontSize: 18.0,
                    fontFamily: 'IBM',
                    inherit: true,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child:  Text("إختر مدة إقامتك من خلال إضافة عدد الأشهر ",
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.grey.shade800,
                    fontFamily: 'IBM',
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child: const Text("الخطوة الثالثة",
                  style: TextStyle(
                    fontSize: 18.0,
                    fontFamily: 'IBM',
                    inherit: true,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child:  Text("إضغط على زر 'تأكيد الحجز'",
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.grey.shade800,
                    fontFamily: 'IBM',
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child: const Text("الخطوة الرابعة",
                  style: TextStyle(
                    fontSize: 18.0,
                    fontFamily: 'IBM',
                    inherit: true,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child:  Text("ستظهر لك رسالة لتأكيد طلب الحجز ،إضغط على زر 'نعم،متابعة'",
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.grey.shade800,
                    fontFamily: 'IBM',
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child: const Text("تم إرسال الطلب",
                  style: TextStyle(
                    fontSize: 18.0,
                    fontFamily: 'IBM',
                    inherit: true,
              ...
              Container(
                width: double.infinity,
                margin: const EdgeInsets.fromLTRB(25, 0, 30, 10),
                child:  Text("سيرسل طلبك إلى المؤجر الذي بدوره يقبل الطلب أو يرفضه، في كلا الحالتين سيصلك إشعار عن الإجراء الذي إتخذه المؤجر.",
                  style: TextStyle(
                    fontSize: 16.0,
                    color: Colors.grey.shade800,
                    fontFamily: 'IBM',
