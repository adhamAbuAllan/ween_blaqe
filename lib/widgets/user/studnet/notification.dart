...
class NotificationOfStudent extends StatefulWidget {
  ...
  @override
  State<NotificationOfStudentWithNotifi> createState() => _NotificationOfStudentWithNotifiState();
}

class _NotificationOfStudentWithNotifiState extends State<NotificationOfStudentWithNotifi> {
  var show = false;
  @override
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Padding(
                  ...
                  child: AddAdDataContainer.ownerId == null ? Container(child:Text(""),):TextButton(onPressed: (){}, child:  const Text("مسح الكل",
           ...
           show == false ? Center(child: Container(
             margin: EdgeInsets.fromLTRB(25, 180, 25, 0),child: TextButton(
               ...
               child: Text("لا يوجد لديك إشعارات", style: TextStyle(
                 fontFamily: "IBM",
...
class _NotificationOfStudentState extends State<NotificationOfStudentWithNotifi> {
  @override
  Widget build(BuildContext context) {
    var title = "شقة للطلاب في مدينة الخليل";
    var location = "الخليل - واد الهرية";
