...
class ApartmentMainImageWidget extends ConsumerStatefulWidget {
  const ApartmentMainImageWidget({super.key,required this.apartmentsRes, required this.index});
  final Apartments apartmentsRes;
  final int index;

  @override
  ConsumerState createState() => _ApartmentMainImageConsumerState();
}

class _ApartmentMainImageConsumerState
    extends ConsumerState<ApartmentMainImageWidget> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        //     child: widget.apartmentsRes.data?[widget.index].photos?[0].url ==
        //         null
        //         ? SkeletonAvatar(
        ...
        //       imageList: widget.apartmentsRes.data![widget.index].photos!,
        //       apartmentId: widget.apartmentsRes.data![widget.index].id!,
        ...
        Padding(
          ...
          child: PointerOfImage(
            imageList: widget.apartmentsRes.data?[widget.index].photos??[],
            oneApartment: widget.apartmentsRes
                .data?[widget.index]??DataOfOneApartment(),
          ),
        ),
...
// class ApartmentMainImageWidget extends StatelessWidget {
//   final Apartments apartmentsRes;
//   final int index;
//
//   const ApartmentMainImageWidget(
