...
class Validator {
  ...
  static String? validatePhone(String value, BuildContext context,
    ...
    if (!value.startsWith('97') && isDebugMode) {
...
//
    if (value.length < 6)
      return SetLocalization.of(context)?.getTranslateValue('weak_password');
  ...
  static String? validateField(
      String fieldKey, String value, BuildContext context,{bool isDebugMode = false}) {
    switch (fieldKey) {
      case 'phone':
        return validatePhone(value, context,isDebugMode: isDebugMode);
      case 'password':
